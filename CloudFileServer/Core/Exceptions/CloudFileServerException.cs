namespace CloudFileServer.Core.Exceptions
{
    ...
    public class CloudFileServerException : Exception
    {
        ...
        public CloudFileServerException(string message, Exception innerException) 
