...
namespace CloudFileServer.Services.Logging
{
    ...
    public class LogService : ILogger
    {
        ...
        public void LogPacket(Packet packet, bool isSending, Guid sessionId)
        {
            ...
            Log(LogLevel.Info, $"[{direction}] Session: {sessionId}, Command: {commandName}, {payloadDesc}");
            
            // Log detailed metadata at Debug level
            Log(LogLevel.Debug, $"[{direction}] Session: {sessionId}, Command: {commandName}, Metadata: {metadata}");
        }
